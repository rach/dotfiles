...
Bundle 'tpope/vim-abolish'
" Abolish is a way to easily search for, substitute, and abbreviate
" multiple variants of a word

Bundle 'chriskempson/vim-tomorrow-theme' 
"Tomorrow theme

Bundle 'kien/tabman.vim'
"TabMan is a Tab management for Vim

Bundle 'benmills/vimux'
"Vimux is a vim plugin to interact with tmux
